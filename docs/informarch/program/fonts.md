...
**Примечание:** Обновление настроек интерфейса происходит 2 раза в секунду (автоматически, по умолчанию), либо с помощью оператора "[REFINT](https://dev.qsp.org/ru/docs/language/qsp-keywords/qsp-keywords-statements#refint)". Также см. оператор "[SETTIMER](https://dev.qsp.org/ru/docs/language/qsp-keywords/qsp-keywords-statements#settimer)".
