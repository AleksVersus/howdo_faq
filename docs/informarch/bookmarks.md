...
# Сборник ссылок и закладок по QSP
<!-- [:informarch_bookmarks] -->
...
### Каноничный конвертер TXT2GAM

- [TXT2GAM релизы на гитхаб](https://github.com/QSPFoundation/txt2gam/releases)

### Пакет qsp-конвертеров

- [www.npmjs.com/qsp-converters](https://www.npmjs.com/package/@qsp/converters)

Пакет для работы с текстовым и бинарным форматом qsp от Werewolf. Если кому-то захочется поиграться - там специально сделано что IO операции не часть пакета (чтобы его можно было в браузере(qspider) и в nodejs использовать), поэтому чтение/запись файла нужно делать средствами nodejs.
...
### qSpider | Плеер с полной поддержкой HTML5
...
### Quest Navigator | Плеер с поддержкой HTML

[Nex-Otaku/quest-navigator-standalone-windows10](https://github.com/Nex-Otaku/quest-navigator-standalone-windows10)

Quest Navigator standalone app for Windows 10. Contribute to Nex-Otaku/quest-navigator-standalone-windows10 development by creating an account on GitHub.
...
Contribute to graylor/FastQSP development by creating an account on GitHub.
...
- Оффлайн-версия справки wiki в формате chm: [на гитхабе](https://github.com/AleksVersus/qsp_wiki_to_help/releases)
...
Демонстрация работы qSpider онлайн. Все игры из каталога `qsp.org` можно установить и опробовать.
