...
Для ответа на этот вопрос подготовлена [синтетическая статья](../program/use_arrays.md) на основе соответствующей [темы](https://qsp.org/index.php?option=com_agora&task=topic&id=93&Itemid=57).
