...
Это, пожалуй, самое основное из грядущих изменений, и о нём мы подробно писали в статье ["Массивы уже не те"](arrays_580/index.md). Здесь же изложим кратко.
