...
- [Пример на условиях](assets/random_goto_1.qsp)
- [Локации записаны в массив](assets/random_goto_2.qsp)
- [Однократное посещение](assets/random_goto_3.qsp)

Так же см. [**Случайный предмет на локации**](random_item.md).
