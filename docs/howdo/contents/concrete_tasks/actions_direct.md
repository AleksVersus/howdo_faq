...
Если вам нужно, чтобы порядок действий менялся динамически, например, выбранное игроком действие добавлялось в конец списка, то действия можно поместить в виде текстовых значений в переменные, или массив.
...
if arrsize('$act_array')=0:
    ...
    $act_array[0]={
        act "<span style='color:red;'>Первое действие</span>":
    ...
    $act_array[1]={
        act "<span style='color:green;'>Второе действие</span>":
    ...
    $act_array[2]={
        act "<span style='color:blue;'>Третье действие</span>":
...
- [Упорядоченные действия](assets/action_direct.qsp).
- [Упорядоченные действия - 2](assets/action_direct_2.qsp).
- [Упорядоченные действия - 3](assets/action_direct_3.qsp)
