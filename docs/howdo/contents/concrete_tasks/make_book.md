...
На созданной локации обработки выделения предмета пишем код для чтения книги:
...
Так же посмотрите раздел вопросов о [создании меню](../menu/menu_of_item), если хотите добавить больше действий с книгой для игрока.
