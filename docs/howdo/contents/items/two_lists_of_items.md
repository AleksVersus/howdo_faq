...
Можно написать универсальные локации для каждого из этих алгоритмов и использовать их, когда нужно. Для подробностей см. [оператор `gosub`](https://dev.qsp.org/ru/docs/language/qsp-keywords/qsp-keywords-statements#gosub).
...
Технически решение этой задачи не отличается от [многоуровневого рюкзака](multi_leveled_backpack.md), поэтому в качестве примеров можно рассмотреть примеры многоуровневого рюкзака:

- [Простой пример](assets/ml_bag.qsp)
- [Пример посложнее. Примитивная таблица данных](assets/ml_bag_2.qsp)
