...
Обратите внимание, везде в этой статье используются глобальные переменные. Попробуйте использовать в последнем примере в качестве счётчика локальную переменную, и объясните его работу.
