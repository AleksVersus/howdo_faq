...
* **themes** — в этом параметре перечисляются кастомные темы оформления. См. [Взаимодействие с интерфейсом](..\qspider_interface.md).
* **defaultTheme** — в этом параметре указывается тема, используемая по умолчанию. См. [Взаимодействие с интерфейсом](..\qspider_interface.md).
...
Смотрите так же раздел ["Особенности работы игр AeroQSP на qSpider"](..\qspider_aeroqsp.md)
